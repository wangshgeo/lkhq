...
std::optional<KMove> MaskedFeasibleFinder::find_best(
    const std::vector<primitives::point_id_t>& actives)
{
    reset_search();
    m_mask.reset(actives);
    for (auto i : actives)
    {
...
void MaskedFeasibleFinder::start_search(const primitives::point_id_t swap_start
...
void MaskedFeasibleFinder::delete_edge(const primitives::length_t removed
...
void MaskedFeasibleFinder::add_edge(const primitives::point_id_t new_start
...
void MaskedFeasibleFinder::reset_search()
{
    m_kmove.clear();
...
bool MaskedFeasibleFinder::gainful(
    primitives::length_t new_length
    , primitives::length_t removed_length) const
{
